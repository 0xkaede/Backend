...
namespace KaedeBackend.Utils
{
    ...
    {
        public static string CreateAccess(UserProfile user, string clientId, string grant_type, string deviceId, int expiresIn)
        {
            ...
            AccessTokens.Add(new AccessTokensGlobal { AccessToken = "eg1~" + token, AccountId = user.AccountId });

            return token;
        }

        public static string CreateRefresh(UserProfile user, string clientId, string grant_type, string deviceId, int expiresIn)
        {
            ...
            RefreshTokens.Add(new AccessTokensGlobal { AccessToken = "eg1~" + token, AccountId = user.AccountId });
